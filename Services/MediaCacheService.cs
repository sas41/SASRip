...
public class MediaCacheService : IMediaCache
{
    ...
    public MediaCacheService(IConfigurationService cfg)
    {
        ...
        MediaCacheCleanupWatchdog clearingService = new MediaCacheCleanupWatchdog(cfg.CachedMediaCheckupTimeSeconds, cfg.CachedMediaLifeTimeSeconds, cfg.FileOutputPath, this);
    }
